...
export function Hero() {
  ...
  return (
    <section className="relative min-h-[100svh] flex flex-col justify-center px-6 md:px-12 pt-32 pb-20 overflow-hidden noise">
      {/* Hero photo — Thomas + the truck, full right side */}
      <div className="absolute top-0 right-0 bottom-0 w-full md:w-[52%] z-0">
        ...
        {/*
          Cream gradient:
          - Mobile (image fills whole screen): harder cream veil on the top-left so text is legible over the photo
          - Desktop: short cream feather on the left edge only, image stays clean in the middle/right
        */}
        <div
          className="absolute inset-0 bg-gradient-to-r from-cream/85 from-0% via-cream/20 via-35% to-transparent to-55% md:from-cream md:from-0% md:via-cream/20 md:via-20% md:to-transparent md:to-35%"
        />
        {/* Soft darken at bottom for scroll hint contrast */}
        <div className="absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-cream/40 to-transparent" />
      </div>
